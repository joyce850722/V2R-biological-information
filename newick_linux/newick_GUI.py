...
class MyFrame1 ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"newick 分析", pos = wx.DefaultPosition, size = wx.Size( 420,390 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		gSizer2.Add( self.m_button6, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_RIGHT|wx.ALL, 5 )
		...
		self.merge_st = wx.TextCtrl( sbSizer1.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 70,23 ), 0 )
		fgSizer1.Add( self.merge_st, 0, wx.ALL, 5 )
		...
		self.merge_ed = wx.TextCtrl( sbSizer1.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 70,23 ), 0 )
		fgSizer1.Add( self.merge_ed, 0, wx.ALL, 5 )
		...
		self.value = wx.TextCtrl( sbSizer2.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 100,23 ), 0 )
		fgSizer2.Add( self.value, 0, wx.ALL, 5 )
		...
		self.m_textCtrl9 = wx.TextCtrl( sbSizer3.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 100,23 ), 0 )
		...
		self.m_textCtrl12 = wx.TextCtrl( sbSizer5.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 100,23 ), 0 )
		...
		self.m_staticText14 = wx.StaticText( sbSizer5.GetStaticBox(), wx.ID_ANY, u"相近點：", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText14.Wrap( -1 )
		fgSizer51.Add( self.m_staticText14, 0, wx.ALL, 5 )
		
		self.m_textCtrl10 = wx.TextCtrl( sbSizer5.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 100,23 ), 0 )
		fgSizer51.Add( self.m_textCtrl10, 0, wx.ALL, 5 )
		
		
		sbSizer5.Add( fgSizer51, 1, wx.EXPAND, 5 )
		...
		self.m_staticText151 = wx.StaticText( self, wx.ID_ANY, u"檔案名稱：", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText151.Wrap( -1 )
		gSizer21.Add( self.m_staticText151, 0, wx.ALIGN_RIGHT|wx.ALL, 5 )
		
		self.m_staticText161 = wx.StaticText( self, wx.ID_ANY, u"未成功匯入檔案 . . .", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText161.Wrap( -1 )
		gSizer21.Add( self.m_staticText161, 0, wx.ALL, 5 )
		
		self.m_staticText1511 = wx.StaticText( self, wx.ID_ANY, u"目前狀態：", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText1511.Wrap( -1 )
		gSizer21.Add( self.m_staticText1511, 0, wx.ALIGN_RIGHT|wx.ALL, 5 )
		
		self.m_staticText16 = wx.StaticText( self, wx.ID_ANY, u"未成功匯入檔案 . . .", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText16.Wrap( -1 )
		gSizer21.Add( self.m_staticText16, 0, wx.ALL, 5 )
		...
		self.m_button6.Bind( wx.EVT_BUTTON, self.explanation )
